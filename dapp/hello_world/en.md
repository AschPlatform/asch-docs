...
dapps
└───<dapp id>
   └─contract/                  # this folders contains all front-end files smart contracts
   └─interface/                 # this folders contains the endpoint of the REST API's
   └─model/                     # this folders contains the description of the DB models
   └─public/                    # this folders contains all front-end files
   blockchain.db                # the database description of DApp
